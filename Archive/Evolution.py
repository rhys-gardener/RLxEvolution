...
def gym_fit():
    ...
    organism_creator = Organism([observation_space, 16, 16, 16, action_space], output='softmax')
    ...
    scoring_function = lambda organism : simulate_and_evaluate(organism, trials=1)
    ecosystem = Ecosystem(organism_creator, scoring_function, 
                        population_size=10, holdout=0.1, mating=True)
